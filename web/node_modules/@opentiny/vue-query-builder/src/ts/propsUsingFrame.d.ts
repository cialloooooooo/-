import { Classname, Combinator, Field, Operator, OptionList, ParseNumbersMethod, ValueEditorType, ValueSource, ValueSources } from './basic';
import { DropEffect } from './dnd';
import { Classnames, CombinatorSelectorProps, CommonSubComponentProps, DragHandleProps, FieldSelectorProps, NotToggleProps, OperatorSelectorProps, QueryActions, SelectorOrEditorProps, Translations, TranslationWithLabel, ValueSelectorProps, ValueSourceSelectorProps } from './props';
import { RuleGroupType, RuleType } from './ruleGroups';
import { RuleGroupTypeAny, RuleGroupTypeIC, RuleOrGroupArray } from './ruleGroupsIC';
import { QueryValidator, ValidationMap } from './validation';
 ...
 */
export type QueryBuilderProps<RG extends RuleGroupType | RuleGroupTypeIC = RuleGroupType> = (QueryBuilderPropsBase<RG> & {
    /**
