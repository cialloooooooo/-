...
var _hoisted_15 = {
  class: "font-[inherit] whitespace-pre-wrap break-words"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(
    "div",
    {
      ...
      onMouseleave: _cache[29] || (_cache[29] = function($event) {
    ...
    [_ctx.type !== "textarea" ? (openBlock(), createElementBlock(
      ...
      [_ctx.state.isDisplayOnly ? (openBlock(), createBlock(_component_tiny_tooltip, {
        ...
        default: withCtx(function() {
          return [createElementVNode("div", _hoisted_14, [createElementVNode(
            ...
            {
              ref: "textBox",
              class: normalizeClass(["text-box block max-w-full min-w-0 break-words text-sm leading-5 text-color-text-primary", [_ctx.state.inputSizeMf !== "mini" ? "sm:text-sm" : "sm:text-xs", _ctx.hoverExpand ? "line-clamp-1" : _ctx.state.showMoreBtn ? "line-clamp-5 whitespace-pre-wrap pr-10" : "line-clamp-5 whitespace-pre-wrap", _ctx.autosize && "whitespace-pre-line"]]),
        ...
        onCompositionstart: _cache[19] || (_cache[19] = function() {
          return _ctx.handleCompositionStart && _ctx.handleCompositionStart.apply(_ctx, arguments);
        }),
        onCompositionupdate: _cache[20] || (_cache[20] = function() {
          return _ctx.handleCompositionUpdate && _ctx.handleCompositionUpdate.apply(_ctx, arguments);
        }),
        onCompositionend: _cache[21] || (_cache[21] = function() {
          return _ctx.handleCompositionEnd && _ctx.handleCompositionEnd.apply(_ctx, arguments);
        }),
        ...
        onBlur: _cache[24] || (_cache[24] = function() {
          return _ctx.handleBlur && _ctx.handleBlur.apply(_ctx, arguments);
        }),
        onChange: _cache[25] || (_cache[25] = function() {
          return _ctx.handleChange && _ctx.handleChange.apply(_ctx, arguments);
        }),
        onMouseenter: _cache[26] || (_cache[26] = function($event) {
          return _ctx.handleEnterTextarea($event);
        }),
        onMouseleave: _cache[27] || (_cache[27] = function($event) {
      ...
      role: "status",
      "aria-live": "polite"
    }, toDisplayString(_ctx.state.showWordLimit ? _ctx.state.textLength + "/" + _ctx.state.upperLimit : _ctx.state.textLength), 9, _hoisted_17)) : createCommentVNode("v-if", true), renderSlot(_ctx.$slots, "default")],
    38
