...
var classes = {
  ...
  "search-selector": "absolute top-full left-0 overflow-hidden min-w-[theme(spacing.18)] border border-solid border-color-border rounded text-xs shadow bg-color-bg-1 text-color-text-primary mt-0.5 hidden sm:block",
  "search-selector-body": "max-h-[theme(spacing.72)] overflow-x-hidden overflow-y-auto",
  "search-selector-poplist-item": "flex items-center h-8 !px-2 max-w-full overflow-hidden text-left text-ellipsis whitespace-nowrap cursor-pointer hover:bg-color-bg-2",
...
var _hoisted_3 = ["placeholder", "aria-label", "aria-expanded", "aria-controls", "tabindex"];
var _hoisted_4 = ["id"];
var _hoisted_5 = {
  "data-tag": "tiny-search__poplist"
};
var _hoisted_6 = ["aria-label", "aria-selected", "id", "onClick"];
var _hoisted_7 = {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    role: "search",
    "aria-label": _ctx.placeholder || "search",
    ...
    [createVNode(Transition, {
      ...
      default: withCtx(function() {
        return [withDirectives(createElementVNode("div", {
          ...
          2
          /* CLASS */
        )], 10, _hoisted_2), [[vShow, !_ctx.state.collapse && _ctx.state.types.length]])];
      }),
      _: 3
      /* FORWARDED */
      ...
      role: "searchbox",
      "aria-label": _ctx.placeholder || "search input",
      "aria-expanded": _ctx.state.show,
      "aria-controls": _ctx.state.show ? "tiny-search__selector-" + _ctx.state.instanceId : void 0,
      "aria-haspopup": "listbox",
    ...
    }, null, 46, _hoisted_3), [[vModelText, _ctx.state.currentValue]]), createVNode(Transition, {
      ...
      default: withCtx(function() {
        return [_ctx.state.showClear && !_ctx.state.collapse ? (openBlock(), createElementBlock(
          ...
          [createElementVNode(
            "a",
            {
              class: normalizeClass(_ctx.m(_ctx.gcls("pc-search-input-btn-transtion-a"))),
              role: "button",
              tabindex: "0",
      ...
      [createElementVNode(
        "a",
        {
          class: normalizeClass(_ctx.m(_ctx.gcls("pc-search-input-btn-a"))),
          role: "button",
          tabindex: "0",
    ...
    default: withCtx(function() {
      return [withDirectives(createElementVNode("div", {
        ...
        id: "tiny-search__selector-" + _ctx.state.instanceId,
        ...
        [createElementVNode("ul", _hoisted_5, [(openBlock(true), createElementBlock(
          Fragment,
          null,
          renderList(_ctx.state.types, function(item, index) {
            return openBlock(), createElementBlock("li", {
              ...
              "aria-selected": item === _ctx.state.searchValue,
              id: "tiny-search__option-" + _ctx.state.instanceId + "-" + index,
              tabindex: "-1",
        ...
        2
        /* CLASS */
      )], 10, _hoisted_4), [[vShow, _ctx.state.show && _ctx.state.types.length]])];
    }),
    _: 3
    /* FORWARDED */
  }), createElementVNode(
    ...
    [createVNode(_component_tiny_input, {
      ...
      name: "suffix",
      fn: withCtx(function() {
        return [createElementVNode("span", _hoisted_7, [createVNode(_component_icon_error, {
          "data-tag": "tiny-svg-size",
