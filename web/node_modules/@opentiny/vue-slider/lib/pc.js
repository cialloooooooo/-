...
var _hoisted_1 = ["aria-label", "aria-valuenow", "aria-valuemin", "aria-valuemax", "aria-valuetext", "aria-orientation", "aria-disabled"];
  ...
  return openBlock(), createElementBlock(
    ...
    [createElementVNode(
      ...
      [createVNode(Transition, {
        ...
        _: 1
        /* STABLE */
      }, 8, ["onBeforeAppear", "onAfterAppear"]), _ctx.state.leftBtnShow ? (openBlock(), createElementBlock("div", {
        key: 0,
      ...
      }, _hoisted_3, 46, _hoisted_1)) : createCommentVNode("v-if", true), _ctx.state.rightBtnShow ? (openBlock(), createElementBlock("div", {
        key: 1,
        class: normalizeClass(["tiny-slider__handle", {
      ...
      }, _hoisted_6, 46, _hoisted_4)) : createCommentVNode("v-if", true), withDirectives(createElementVNode(
        "div",
        {
          ref: "sliderTip",
        ...
        5
        /* TEXT, STYLE */
      ), [[vShow, _ctx.showTip && _ctx.state.showTip]]), _ctx.state.markList ? (openBlock(), createElementBlock("div", _hoisted_7, [(openBlock(true), createElementBlock(
        Fragment,
        null,
      ...
      [renderSlot(_ctx.$slots, "default", {
        ...
        return [!_ctx.state.isDouble ? (openBlock(), createBlock(_component_tiny_input, {
          ...
          }, null, 8, ["modelValue", "disabled", "onFocus", "onBlur"]), _hoisted_8, createVNode(_component_tiny_input, {
