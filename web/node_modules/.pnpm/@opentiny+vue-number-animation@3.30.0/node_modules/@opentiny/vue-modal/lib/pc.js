...
import { api, renderless } from "@opentiny/vue-renderless/modal/vue";
import "@opentiny/vue-theme/modal/index.css";
import { iconLoadingShadow, iconError, iconWarning, iconSuccess, iconHelp, iconHelpSolid, iconMinscreenRight, iconFullscreenRight, iconClose } from "@opentiny/vue-icon";
var _sfc_main = /* @__PURE__ */ defineComponent({
  props: [].concat(props, ["_constants", "animat", "beforeClose", "duration", "escClosable", "events", "fullscreen", "height", "id", "isFormReset", "lockScroll", "lockView", "marginSize", "mask", "maskClosable", "message", "minHeight", "minWidth", "modelValue", "resize", "showFooter", "showHeader", "status", "title", "top", "type", "vSize", "width", "zIndex", "messageClosable", "confirmContent", "cancelContent", "confirmBtnProps", "cancelBtnProps", "headerDragable", "footerDragable", "tiny_theme", "slots", "showClose"]),
  ...
  render: function render() {
    ...
    var _this$$props = this.$props, $props = _this$$props === void 0 ? {} : _this$$props, state = this.state, scopedSlots = this.scopedSlots, vSize = this.vSize, type = this.type, resize = this.resize, showClose = this.showClose, animat = this.animat, status = this.status, showHeader = this.showHeader, messageClosable = this.messageClosable;
    ...
    return h("div", {
      class: ["tiny-modal", "tiny-modal__wrapper", "type__" + type, (_ref3 = {}, _ref3["size__" + vSize] = vSize, _ref3["status__" + status] = typeof status === "string", _ref3.is__animat = animat, _ref3.lock__scroll = lockScroll, _ref3.lock__view = lockView, _ref3.is__mask = mask, _ref3.is__maximize = zoomLocat, _ref3.is__visible = contentVisible, _ref3.active = visible, _ref3.leave = !contentVisible, _ref3)],
      style: {
      ...
      on: {
        mousedown: this.headerDragable ? this.mousedownEvent : function() {
        }
      }
    }, [status ? h("div", {
