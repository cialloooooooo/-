  ...
  files2urls(files, placeholders, originalUrls, pastedDelta, imageIndexs) {
    return Promise.all(
      files.map(async (imageFile, index) => {
        ...
        if (((_a = originalUrls[index]) == null ? void 0 : _a.src) && ((_b = originalUrls[index]) == null ? void 0 : _b.src) !== "//:0") {
          imageUrl = originalUrls[index].src;
        }
        if (!placeholders[index] && originalUrls[index] && netImgExp.test(imageUrl)) {
          return new Promise((resolve) => {
            resolve(originalUrls[index]);
          });
        } else if ((_c = this.quill.options.uploadOption) == null ? void 0 : _c.imageUploadToServer) {
      ...
      delta.map(async (op) => {
        ...
        try {
          ...
          if (clipboardFiles.length !== 0) {
            ...
            const errorImagePlaceholderJpg = this.quill.getLangText("img-error") === "Image Copy Error" ? ERROR_IMAGE_PLACEHOLDER_EN : ERROR_IMAGE_PLACEHOLDER_CN;
