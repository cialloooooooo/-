...
import { iconDocument, iconSuccessful, iconClose, iconView, iconDel, iconYes, iconCloseCircle, iconError, iconFileCloudupload, iconDownload, iconCueL, iconRefresh, IconError, iconFullscreenLeft, iconRight, iconPause, iconAudio, iconEllipsis, iconExcelType, iconFileType, iconOtherType, iconPdfType, iconPictureType, iconPptType, iconTextType, iconVideoType, iconWordType, iconZipType, iconFileuploadPro } from '@opentiny/vue-icon';
...
var _hoisted_33 = ["title", "aria-label", "onClick"];
var _hoisted_34 = {
  key: 6,
  class: "tiny-icon-close-tip"
};
var _hoisted_35 = ["aria-label", "onClick"];
var _hoisted_36 = {
  class: "tiny-upload-list__item-tooltip"
};
var _hoisted_37 = {
...
var _hoisted_41 = ["title", "aria-label", "onClick"];
...
var _hoisted_44 = {
  class: "tiny-upload-list__text-desc"
};
        ...
        renderList(_ctx.files, function(file) {
          return openBlock(), createElementBlock("li", {
            ...
            return [file.status !== "uploading" && file.status !== "fail" && ["picture-card", "picture"].indexOf(_ctx.listType) > -1 ? (openBlock(), createElementBlock("img", {
              ...
              "aria-label": _ctx.t("ui.fileUpload.deleteFile") + " " + file.name,
              onClick: function onClick($event) {
              ...
              role: "button",
              tabindex: "0",
              "aria-label": _ctx.t("ui.fileUpload.cancelFile") + " " + file.name,
              onClick: function onClick($event) {
                return _ctx.$emit("remove", file);
              }
