...
var _hoisted_16 = ["aria-label", "onClick"];
var _hoisted_17 = {
...
var _hoisted_38 = ["aria-label", "onClick"];
...
var _hoisted_55 = {
  class: "block sm:group-hover/upload-list:hidden"
};
var _hoisted_56 = {
  class: "mt-1 text-color-text-inverse text-xs"
};
var _hoisted_57 = {
  class: "hidden sm:group-hover/upload-list:block"
};
var _hoisted_58 = {
  key: 2
};
...
var _hoisted_64 = /* @__PURE__ */ createElementVNode(
  "div",
  {
...
var _hoisted_66 = /* @__PURE__ */ createElementVNode(
  "div",
  {
    class: "h-2 bg-color-bg-2"
  },
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [_ctx.listType === "text" || _ctx.listType === "saas" ? (openBlock(), createElementBlock(
      ...
      renderList(_ctx.state.files, function(file, index) {
        return openBlock(), createElementBlock("div", {
          ...
          return [createElementVNode(
            ...
            title: file.name
          }, toDisplayString(file.name.length > _ctx.maxNameLength ? file.name.substring(0, _ctx.maxNameLength) + "..." : file.name), 9, _hoisted_11)]), createElementVNode("div", _hoisted_12, [renderSlot(_ctx.$slots, "operate", {
            file
          }, function() {
            return [_ctx.handlePreview && ~["success", "downloading"].indexOf(file.status) ? (openBlock(), createElementBlock("span", {
              ...
              role: "button",
              tabindex: "0",
              "aria-label": _ctx.t("ui.uploadList.delete") + " " + file.name,
          ...
          }, null, 8, ["aria-label", "onClick"])) : createCommentVNode("v-if", true)]), createElementVNode("div", {
    ...
    [(openBlock(true), createElementBlock(
      ...
      renderList(_ctx.files, function(file, index) {
        return openBlock(), createElementBlock("div", {
          class: normalizeClass(["group/upload-list relative", {
          ...
          return [!_ctx.displayOnly && (file.status !== "uploading" || ~["video", "audio"].indexOf(file.type)) ? (openBlock(), createBlock(_component_icon_error, {
          ...
          }, null, 8, ["class", "aria-label", "onClick"])) : createCommentVNode("v-if", true), createElementVNode(
            "div",
            {
              style: normalizeStyle({
                background: _ctx.imageBgColor
              }),
              class: normalizeClass(["relative w-full h-full after:absolute after:w-full after:h-full after:left-0 after:top-0 after:rounded after:bg-color-bg-7", [!~["uploading", "fail"].indexOf(file.status) ? "after:hidden sm:after:group-hover/upload-list:block" : "", {
            ...
            [file.type === "video" ? (openBlock(), createElementBlock(
            ...
            }, null, 8, ["aria-label", "onClick"])) : createCommentVNode("v-if", true)])])) : (openBlock(), createElementBlock("div", _hoisted_58, [createElementVNode(
              "div",
              {
                class: normalizeClass(["hidden", {
                  "sm:group-hover/upload-list:block": !~["video", "audio"].indexOf(file.type)
                }])
              },
              [renderSlot(_ctx.$slots, "operate", {
                ...
                }, null, 8, ["aria-label", "onClick"])) : createCommentVNode("v-if", true)];
              })],
              2
              /* CLASS */
            ), file.type === "video" ? (openBlock(), createElementBlock(
              ...
              {
                key: 0,
                class: normalizeClass(["inline-block w-8 h-8 text-center rounded-full group-hover/upload-list:bg-color-bg-7", !file.isPlay ? "bg-color-bg-7" : "bg-opacity-0"])
              },
    ...
    default: withCtx(function() {
      return [renderSlot(_ctx.$slots, "operate", {
        ...
        return [createElementVNode("div", _hoisted_62, [_ctx.handleDownloadFile ? (openBlock(), createElementBlock(
          ...
          1
          /* TEXT */
        )) : createCommentVNode("v-if", true), !_ctx.displayOnly ? (openBlock(), createElementBlock("div", {
          key: 2,
          "data-tag": "tiny-upload-list-panel",
          class: "h-12 flex items-center justify-center cursor-pointer",
          role: "button",
          tabindex: "0",
          "aria-label": _ctx.state.currentFile ? _ctx.t("ui.uploadList.delete") + " " + _ctx.state.currentFile.name : _ctx.t("ui.uploadList.delete"),
        ...
        }, toDisplayString(_ctx.t("ui.uploadList.delete")), 9, _hoisted_63)) : createCommentVNode("v-if", true), _hoisted_64, createElementVNode(
          "div",
          {
            class: "h-12 flex items-center justify-center cursor-pointer",
    ...
    default: withCtx(function() {
      return [createElementVNode("div", _hoisted_65, [createElementVNode(
        "div",
        {
          class: "h-12 flex items-center justify-center cursor-pointer",
        ...
        1
        /* TEXT */
      ), _hoisted_66, createElementVNode(
        "div",
        {
          class: "h-12 flex items-center justify-center cursor-pointer",
