...
import { resolveComponent, openBlock, createElementBlock, normalizeClass, normalizeStyle, withKeys, createElementVNode, renderSlot, createTextVNode, createCommentVNode, createBlock, toDisplayString } from 'vue';
...
var _sfc_main = defineComponent({
  ...
  props: [].concat(props, ["modelValue", "trueValue", "falseValue", "disabled", "mini", "tabindex", "showText", "beforeChange", "displayOnly", "loading", "width"]),
  components: {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return !_ctx.state.isDisplayOnly ? (openBlock(), createElementBlock("span", {
    ...
    "aria-label": _ctx.state.showText ? _ctx.state.currentValue === _ctx.trueValue ? "on" : "off" : void 0,
    class: normalizeClass([_ctx.state.wrapClasses, _ctx.state.showText ? "tiny-switch__text" : ""]),
    tabindex: _ctx.tabindex,
    style: normalizeStyle(_ctx.state.switchStyle),
    ...
    key: 2
  }) : createCommentVNode("v-if", true)])], 46, _hoisted_1)) : (openBlock(), createElementBlock(
    "span",
    {
      key: 1,
      style: normalizeStyle(_ctx.state.displayOnlyStyle)
    },
    [_ctx.state.currentValue === _ctx.trueValue ? renderSlot(_ctx.$slots, "open", {
      key: 0
    }, function() {
