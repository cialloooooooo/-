...
import { resolveComponent, openBlock, createBlock, resolveDynamicComponent, mergeProps, withCtx, renderSlot, createElementBlock, Fragment, renderList, createCommentVNode } from 'vue';
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(resolveDynamicComponent(_ctx.state.tag), mergeProps({
    class: ["inline-flex", _ctx.vertical && "flex-col"],
    role: "radiogroup",
