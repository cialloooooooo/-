...
import { resolveDirective, openBlock, createElementBlock, mergeProps, withKeys, withModifiers, createElementVNode, normalizeClass, withDirectives, vModelRadio, renderSlot, createTextVNode, toDisplayString, createCommentVNode } from 'vue';
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return !_ctx.state.isDisplayOnly || _ctx.state.model === _ctx.label ? (openBlock(), createElementBlock("label", mergeProps({
    ...
    class: ["tiny-radio", [_ctx.border && _ctx.state.radioSize ? "tiny-radio--" + _ctx.state.radioSize : "", {
      ...
      "is-checked": _ctx.state.model === _ctx.label
    }, {
    ...
    }, null, 40, _hoisted_3), [[vModelRadio, _ctx.state.model]])],
    2
    /* CLASS */
  ...
  })], 40, _hoisted_4)), [[_directive_auto_tip]])], 16, _hoisted_1)) : createCommentVNode("v-if", true);
}
