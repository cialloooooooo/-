import { Combinator, Operator, ValueSource } from './basic';
interface CommonProperties {
    path?: number[];
    id?: string;
    disabled?: boolean;
}
export type RuleType<F extends string = string, O extends string = string, V = any, C extends string = string> = CommonProperties & {
    field: F;
    operator: O;
    value: V;
