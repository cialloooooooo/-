...
import { defineComponent, $props, $setup, $prefix, setupComponent, createComponent } from "@opentiny/vue-common";
...
var TINYModalComponent = TINYModal;
...
types.forEach(function(type) {
  TINYModalComponent[type] = Modal[type] = function(message2, title, options) {
    var opts = {};
...
TINYModalComponent.install = function(Vue) {
