...
import { iconClose, iconCopy, iconAddCircle, iconLoadingShadow, iconHalfselect, iconCheck, iconCheckedSur, iconSearch, iconDownWard, iconEllipsis, iconChevronUp } from '@opentiny/vue-icon';
...
import { resolveComponent, resolveDirective, withDirectives, openBlock, createElementBlock, normalizeClass, withModifiers, createElementVNode, normalizeStyle, renderSlot, createBlock, createCommentVNode, withCtx, createVNode, createTextVNode, toDisplayString, Fragment, renderList, createSlots, withKeys, vShow, vModelText, resolveDynamicComponent, Transition, mergeProps } from 'vue';
...
var _hoisted_12 = ["disabled", "autocomplete"];
var _hoisted_13 = {
  key: 0,
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createElementBlock(
    ...
    {
      ref: "select",
      class: normalizeClass(["tiny-select", [_ctx.state.selectSize ? "tiny-select--" + _ctx.state.selectSize : "", _ctx.state.collapseTags ? "tiny-select__collapse-tags" : "", _ctx.filterable ? "tiny-select__filterable" : "", _ctx.multiple ? "tiny-select__multiple" : "", (_ctx.state.inputHovering || _ctx.state.visible) && !_ctx.clickExpand ? "is-hover" : "", _ctx.state.isDisplayOnly ? "is-display-only" : "", _ctx.hoverExpand ? "is-hover-expand" : "", _ctx.clickExpand ? "is-click-expand" : "", _ctx.state.showCollapseTag ? "collapse-tag-clicked" : "", _ctx.state.isDisabled ? "is-disabled" : ""]]),
    ...
    [createElementVNode("div", {
      ...
      title: _ctx.state.rootAutoTipConfig.content
      ...
      return [_ctx.shape === "filter" ? (openBlock(), createBlock(_component_tiny_filter_box, {
        ...
        [!_ctx.state.isShowTagText ? (openBlock(), createElementBlock("span", _hoisted_2, [_ctx.collapseTags && _ctx.state.selected.length ? (openBlock(), createElementBlock("span", _hoisted_3, [(openBlock(), createBlock(_component_tiny_tag, {
          ...
          default: withCtx(function() {
            return [createVNode(_component_tiny_tooltip, {
              ...
              content: withCtx(function() {
                return [_ctx.state.tooltipContent[_ctx.getValueKey(_ctx.state.selected[0])] ? (openBlock(), createElementBlock("span", _hoisted_5, [renderSlot(_ctx.$slots, "label", {
                    ...
                    return [createVNode(_component_tiny_tooltip, {
                      ...
                      default: withCtx(function() {
                        return [!_ctx.state.visible && _ctx.state.overflow === index ? (openBlock(), createElementBlock(
                          ...
                          1
                          /* TEXT */
                        )) : (openBlock(), createElementBlock("span", _hoisted_9, [renderSlot(_ctx.$slots, "label", {
                      ...
                      fn: withCtx(function() {
                        return [!_ctx.state.visible && _ctx.state.overflow === index ? (openBlock(), createElementBlock(
                          ...
                          1
                          /* TEXT */
                        )) : (openBlock(), createElementBlock("span", _hoisted_11, [renderSlot(_ctx.$slots, "label", {
                          item: _ctx.getLabelSlotValue(item)
                        }, function() {
                          return [createTextVNode(
                            toDisplayString(item.state ? item.state.currentLabel : item.currentLabel),
          ...
          {
            key: 1,
            class: normalizeClass(["tiny-select__tags-text", "is-display-only", {
        ...
        }, null, 46, _hoisted_12), [[vShow, _ctx.filterable && !_ctx.searchable && !_ctx.state.selectDisabled], [vModelText, _ctx.state.query]])],
        6
        /* CLASS, STYLE */
        ...
        inputBoxType: _ctx.inputBoxType,
        class: normalizeClass({
        ...
        "aria-owns": _ctx.state.ariaListId,
        "aria-controls": _ctx.state.ariaListId
      }, createSlots({
        ...
        return [withDirectives(createVNode(_component_tiny_select_dropdown, {
          ...
          default: withCtx(function() {
            ...
            return [_ctx.shape && _ctx.filterable ? (openBlock(), createElementBlock(
              ...
              2
              /* CLASS */
            )) : createCommentVNode("v-if", true), _ctx.topCreate ? (openBlock(), createElementBlock("div", _hoisted_15, [createElementVNode("div", {
              ...
              key: 2,
              "auto-resize": "",
              "row-id": _ctx.gridOp.rowId || _ctx.valueField,
              ...
              4
              /* STYLE */
            )) : createCommentVNode("v-if", true), !_ctx.optimization && !~["grid", "tree"].indexOf(_ctx.renderType) && !(_ctx.state.isDisplayOnly && _ctx.options) ? withDirectives((openBlock(), createBlock(_component_tiny_scrollbar, {
              key: 6,
              ref: "scrollbar",
              show: "",
              tag: "ul",
              ...
              default: withCtx(function() {
                return [renderSlot(_ctx.$slots, "dropdown"), _ctx.multiple && _ctx.showCheck && _ctx.showAlloption && !_ctx.state.multipleLimit && !_ctx.state.query && !_ctx.remote ? (openBlock(), createElementBlock(
                  ...
                  [createElementVNode("span", _hoisted_17, [(openBlock(), createBlock(resolveDynamicComponent("icon-" + _ctx.state.selectCls), {
                    class: normalizeClass(["tiny-svg-size", _ctx.state.selectCls])
                  }, null, 8, ["class"]))]), createElementVNode("div", _hoisted_18, [createElementVNode(
                    "span",
                    _hoisted_19,
                    toDisplayString(_ctx.allText || _ctx.t("ui.base.all")),
                    1
                  ...
                  [createElementVNode("span", _hoisted_20, [(openBlock(), createBlock(resolveDynamicComponent("icon-" + _ctx.state.filteredSelectCls), {
                    class: normalizeClass(["tiny-svg-size", _ctx.state.filteredSelectCls])
                  }, null, 8, ["class"]))]), createElementVNode("div", _hoisted_21, [createElementVNode(
                    "span",
                    _hoisted_22,
                    toDisplayString(_ctx.allText || _ctx.t("ui.base.all")),
                    1
              ...
              [_ctx.loadingText || _ctx.slots.empty ? (openBlock(), createElementBlock("div", _hoisted_23, [_ctx.slots.empty ? renderSlot(_ctx.$slots, "empty", {
                key: 0
              }) : _ctx.showEmptyImage ? (openBlock(), createElementBlock("span", _hoisted_24)) : (openBlock(), createElementBlock(
                "p",
                _hoisted_25,
                ...
                [_ctx.loading ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.state.designConfig && _ctx.state.designConfig.icons && _ctx.state.designConfig.icons.loadingIcon || "icon-loading-shadow"), {
                  key: 0,
                  class: "circular"
                })) : (openBlock(), createElementBlock(
                  Fragment,
                  ...
                  [_ctx.showEmptyImage ? (openBlock(), createElementBlock("span", _hoisted_26)) : (openBlock(), createElementBlock(
                    "span",
                    _hoisted_27,
                    toDisplayString(_ctx.state.emptyText),
                    1
          ...
          _: 3
          /* FORWARDED */
        }, 8, ["is-drop-inherit-width", "placement", "append-to-body", "style", "popper-options", "id"]), [[vShow, !_ctx.onCopying() && !_ctx.hideDrop && _ctx.state.visible && _ctx.state.emptyText !== false]])];
      }),
      _: 3
      /* FORWARDED */
    }, 8, ["onBeforeEnter", "onAfterLeave"])], 14, _hoisted_1), _ctx.hoverExpand && !_ctx.state.isDisplayOnly ? (openBlock(), createElementBlock("div", _hoisted_28, _hoisted_30)) : createCommentVNode("v-if", true)],
    34
    /* CLASS, NEED_HYDRATION */
