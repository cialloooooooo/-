...
var RichTextStrikethrough = {
  render
};
var richTextStrikethrough = function richTextStrikethrough2() {
  return svg({
    name: "IconRichTextStrikethrough",
    component: RichTextStrikethrough,
    filledComponent: RichTextStrikethrough
  })();
};
export {
  richTextStrikethrough as default
};
