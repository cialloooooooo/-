...
var _sfc_main = defineComponent({
  ...
  props: [].concat(props, ["dataset", "placeholder", "autoLookup", "beforeReset", "textRenderSource", "resize", "size", "trigger", "conditions", "disabled", "gridOp", "alwaysLoad", "remoteSearch", "treeOp", "icon", "iconSearch", "initSelectedDatas", "multi", "pagerOp", "popseletor", "readonly", "showClearBtn", "showHistory", "showPager", "textField", "textSplit", "title", "modelValue", "valueField", "valueSplit", "width", "dialogClass", "tabindex", "draggable", "lockScroll", "placement", "popperAppendToBody", "suggest", "beforeClose", "showSelectedBox", "selectedBoxOp", "tooltipConfig", "autoReset", "radioChangeClose"]),
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [createVNode(_component_tiny_input, {
    ...
    default: withCtx(function() {
      return [withDirectives(createElementVNode(
        "div",
        _hoisted_2,
        [_ctx.state.showSuggestPanel ? (openBlock(), createBlock(_component_tiny_grid, mergeProps({
          key: 0,
          ref: "suggest"
        }, _ctx.gridOp, {
          "auto-resize": "",
        ...
        }), null, 16, ["loading", "columns", "data", "row-id", "select-config", "radio-config", "tooltip-config", "onSelectAll", "onSelectChange", "onRadioChange"])) : createCommentVNode("v-if", true)],
        512
        /* NEED_PATCH */
      ...
      return [_ctx.state.showContent ? (openBlock(), createElementBlock(
        ...
        [_ctx.state.conditions.length && _ctx.popseletor === "grid" ? (openBlock(), createElementBlock("div", _hoisted_3, [renderSlot(_ctx.$slots, "search", {
          ...
          [createElementVNode("div", _hoisted_9, [createElementVNode("div", _hoisted_10, [createElementVNode("ul", null, [_ctx.showHistory ? (openBlock(), createElementBlock(
            ...
            [renderSlot(_ctx.$slots, "title-history", {}, function() {
            ...
            [renderSlot(_ctx.$slots, "title-source", {}, function() {
              return [createElementVNode(
                "span",
                null,
            ...
            2
            /* CLASS */
          )])]), createElementVNode("div", _hoisted_11, [_ctx.state.activeName === "history" ? (openBlock(), createElementBlock("div", _hoisted_12, [createVNode(_component_tiny_grid, mergeProps({
            ref: "historyGrid"
          }, _ctx.gridOp, {
            height: "290px",
            size: "mini",
            ...
            onSelectAll: _ctx.sourceGridSelectAll,
            onSelectChange: _ctx.sourceGridSelectChange
          }), null, 16, ["columns", "data", "row-id", "select-config", "tooltip-config", "onSelectAll", "onSelectChange"])])) : createCommentVNode("v-if", true), _ctx.state.activeName === "source" ? (openBlock(), createElementBlock("div", _hoisted_13, [_ctx.multi ? (openBlock(), createBlock(_component_tiny_grid, mergeProps({
            key: 0
          }, _ctx.gridOp, {
            "auto-resize": "",
            loading: _ctx.state.loading,
            ...
            onSelectAll: _ctx.sourceGridSelectAll,
            onSelectChange: _ctx.sourceGridSelectChange
          }), null, 16, ["loading", "columns", "data", "row-id", "select-config", "tooltip-config", "onSelectAll", "onSelectChange"])) : (openBlock(), createBlock(_component_tiny_grid, mergeProps({
            key: 1,
            ref: "sourceGrid"
          }, _ctx.gridOp, {
            "auto-resize": "",
            ...
            "tooltip-config": _ctx.tooltipConfig,
            onRadioChange: _ctx.radioChangeFn
          }), null, 16, ["loading", "columns", "data", "row-id", "radio-config", "tooltip-config", "onRadioChange"])), _ctx.showPager ? (openBlock(), createBlock(_component_tiny_pager, mergeProps({
            key: 2
          ...
          2
          /* CLASS */
        ), _ctx.multi ? (openBlock(), createElementBlock("div", _hoisted_14, [createElementVNode("div", _hoisted_15, [createElementVNode("div", _hoisted_16, [createElementVNode("ul", null, [createElementVNode("li", _hoisted_17, [renderSlot(_ctx.$slots, "title-selection", {}, function() {
          return [createElementVNode(
            "span",
            null,
          ...
          key: "4"
        } : void 0]), 1040, ["select", "onClear", "onDelete", "onDrag"])) : (openBlock(), createBlock(_component_tiny_grid, mergeProps({
          key: 1,
          ref: "selectedGrid"
        }, _ctx.gridOp, {
          "auto-resize": "",
        ...
        }), null, 16, ["columns", "data", "row-id", "select-config", "tooltip-config", "onSelectAll", "onSelectChange"])), _ctx.showPager ? (openBlock(), createElementBlock("div", _hoisted_20)) : createCommentVNode("v-if", true)])])])])) : createCommentVNode("v-if", true)])) : createCommentVNode("v-if", true), _ctx.popseletor === "tree" ? (openBlock(), createElementBlock("div", _hoisted_21, [createVNode(_component_tiny_input, {
          ...
          "prefix-icon": _ctx.iconSearch,
          "suffix-icon": _ctx.iconSearch
        }, null, 8, ["placeholder", "modelValue", "prefix-icon", "suffix-icon"]), createElementVNode(
          "div",
          {
            class: "tiny-popeditor__tree-wrapper",
            style: normalizeStyle({
              maxHeight: _ctx.state.treeWrapperMaxHeight
            })
          },
          [createVNode(_component_tiny_tree, mergeProps({
            ref: "tree"
          }, _ctx.state.treeOp, {
            onCheckChange: _ctx.treeCheckChange
          }), null, 16, ["onCheckChange"])],
          4
          /* STYLE */
    ...
    _: 3
    /* FORWARDED */
  }, 8, ["visible", "resize", "draggable", "title", "width", "before-close", "dialog-class", "lock-scroll"])]);
}
