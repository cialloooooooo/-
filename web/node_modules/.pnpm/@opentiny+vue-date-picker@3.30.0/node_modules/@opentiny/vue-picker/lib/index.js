...
import { resolveComponent, resolveDirective, openBlock, createElementBlock, withDirectives, createBlock, mergeProps, createSlots, withCtx, createElementVNode, createVNode, Transition, resolveDynamicComponent, createCommentVNode, toDisplayString, normalizeClass, renderSlot, normalizeProps, guardReactiveProps, vShow, normalizeStyle, Fragment } from 'vue';
...
var _hoisted_1$1 = {
  ref: "reference",
  class: "tiny-picker tiny-date-container"
};
var _hoisted_2$1 = {
  class: "tiny-input__icon-container"
};
var _hoisted_3$1 = ["placeholder", "value", "disabled", "readonly", "name", "aria-owns", "aria-controls"];
var _hoisted_4$1 = {
  key: 0,
  class: "tiny-range-separator"
};
var _hoisted_5$1 = ["placeholder", "value", "disabled", "readonly", "name"];
var _hoisted_6 = {
  key: 2,
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(
    ...
    [_ctx.shape === "filter" ? withDirectives((openBlock(), createBlock(_component_tiny_filter_box, {
    ...
    }, null, 8, ["onClick", "show-close", "placeholder", "disabled", "label", "tip", "value", "drop-down-visible", "blank", "size"])), [[_directive_clickoutside, _ctx.handleClose, void 0, {
      mousedown: true
      ...
      "aria-owns": _ctx.state.ariaPanelId,
      "aria-controls": _ctx.state.ariaPanelId
    }), createSlots({
      ...
      key: "0"
    } : void 0]), 1040, ["tabindex", "class", "readonly", "disabled", "size", "name", "placeholder", "onFocus", "onKeydown", "model-value", "title", "display-only", "display-only-content", "onInput", "onChange", "onMouseenter", "aria-owns", "aria-controls"])), [[_directive_clickoutside, _ctx.handleClose, void 0, {
      mousedown: true
    }]]) : withDirectives((openBlock(), createElementBlock(
      "div",
      {
        key: 2,
        class: normalizeClass(["tiny-date-editor tiny-range-editor tiny-input tiny-input__inner", ["tiny-date-editor--" + _ctx.state.type, _ctx.state.pickerSize ? "tiny-range-editor--" + _ctx.state.pickerSize + " tiny-input-" + _ctx.state.pickerSize : "", _ctx.state.pickerDisabled ? "is-disabled" : "", _ctx.state.pickerVisible ? "is-active" : "", _ctx.state.isDisplayOnly ? "is-display-only" : ""]]),
      ...
      [_ctx.label && _ctx.shape === "filter" ? (openBlock(), createBlock(_component_tiny_tooltip, {
        key: 0,
        effect: "light",
        content: _ctx.state.labelTooltip,
        placement: "top",
        ...
        _: 1
        /* STABLE */
      }, 8, ["content", "onMouseenter"])) : createCommentVNode("v-if", true), createElementVNode("input", mergeProps({
        autocomplete: "off",
        ...
        tabindex: "1",
        class: "tiny-range-input"
      }), null, 16, _hoisted_5$1), _ctx.state.haveTrigger ? (openBlock(), createElementBlock("i", {
        key: 1,
      ...
      mousedown: true
    }]]), withDirectives((openBlock(), createBlock(resolveDynamicComponent(_ctx.state.panel), {
      step: _ctx.step,
      ...
      id: _ctx.state.ariaPanelId
    }, createSlots({
      _: 2
      /* DYNAMIC */
    }, [_ctx.$slots.footer || _ctx.$slots.now || _ctx.$slots.confirm ? {
      name: "footer",
      fn: withCtx(function(scoped) {
        return [renderSlot(_ctx.$slots, "footer", normalizeProps(guardReactiveProps(scoped)), function() {
          return [renderSlot(_ctx.$slots, "now", normalizeProps(guardReactiveProps(scoped))), renderSlot(_ctx.$slots, "confirm", normalizeProps(guardReactiveProps(scoped)))];
        })];
      }),
      key: "0"
    } : void 0]), 1064, ["step", "show-week-number", "time-editable", "format-weeks", "now-click", "onPick", "onSelectRange", "onSelectChange", "id"])), [[vShow, _ctx.state.pickerVisible]])],
    512
    /* NEED_PATCH */
  );
}
...
var classes = {
  ...
  "range-editor": "bg-color-bg-1 relative flex items-center py-1 sm:px-3 border-0 sm:border border-color-border hover:border-color-border-hover rounded mt-0.5",
  "range-input": "appearance-none border-none outline-0 p-0 w-[38%] text-color-text-primary focus:border-color-brand-focus disabled:border-color-border placeholder:text-color-text-placeholder disabled:cursor-not-allowed text-sm sm:placeholder:text-sm sm:text-sm h-full m-0 truncate disabled:text-color-icon-placeholder disabled:bg-transparent sm:disabled:bg-color-border-disabled",
...
var _hoisted_4 = ["placeholder", "value", "title", "disabled", "readonly", "name"];
var _hoisted_5 = ["placeholder", "value", "title", "disabled", "readonly", "name"];
  ...
  return openBlock(), createElementBlock(
    ...
    [_ctx.shape === "filter" ? withDirectives((openBlock(), createBlock(_component_tiny_filter_box, {
      ...
      "div",
      {
        ...
        style: normalizeStyle(_ctx.state.breakLine ? {
        ...
        onMouseenter: _cache[14] || (_cache[14] = function() {
          return _ctx.handleMouseEnter && _ctx.handleMouseEnter.apply(_ctx, arguments);
        }),
      ...
      [_ctx.label && _ctx.shape === "filter" ? (openBlock(), createBlock(_component_tiny_tooltip, {
        ...
        _: 1
        /* STABLE */
      }, 8, ["content", "onMouseenter"])) : createCommentVNode("v-if", true), !_ctx.state.isDisplayOnly ? (openBlock(), createElementBlock(
        Fragment,
        {
          key: 1
        },
        [_ctx.state.breakLine ? (openBlock(), createElementBlock("div", _hoisted_2, [createElementVNode("input", mergeProps({
          autocomplete: "off",
          placeholder: _ctx.startPlaceholder,
          value: _ctx.state.displayValue && _ctx.state.displayValue[0],
          ...
          style: {
            width: _ctx.state.type === "daterange" ? "45%" : "75%"
          }
          ...
          [createElementVNode("input", mergeProps({
            ...
            "data-tag": "tiny-range-input",
            class: _ctx.gcls("range-input")
          }), null, 16, _hoisted_4), renderSlot(_ctx.$slots, "range-separator", {}, function() {
            return [typeof _ctx.rangeSeparator === "string" ? (openBlock(), createElementBlock(
              "span",
              {
                key: 0,
          ...
          class: _ctx.gcls("range-input"),
          style: {
            width: _ctx.state.breakLine ? "88%" : "38%"
          }
        }), null, 16, _hoisted_5), !_ctx.state.isMobileScreen && _ctx.state.haveTrigger ? (openBlock(), createElementBlock(
          "i",
          {
            key: 2,
          ...
          "i",
          {
            ...
            style: normalizeStyle({
              top: _ctx.state.breakLine ? "30%" : "50%"
            })
          },
          [(openBlock(), createBlock(resolveDynamicComponent(_ctx.state.triggerClass), {
            "custom-class": "h-5 w-5 sm:h-4 sm:w-4",
