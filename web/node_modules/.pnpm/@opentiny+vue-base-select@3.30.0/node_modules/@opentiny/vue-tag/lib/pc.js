...
var _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  render: function render() {
    var type = this.type, size = this.size, hit = this.hit, effect = this.effect, slots = this.slots, closable = this.closable, color = this.color, handleClose = this.handleClose, handleClick = this.handleClick, disabled = this.disabled, state = this.state, value = this.value, onlyIcon = this.onlyIcon, maxWidth = this.maxWidth;
    var styles = {};
    ...
    var tagElement = value || slots.default && slots.default() ? createVNode("span", {
      ...
      "style": styles,
      "onClick": handleClick
    }, [value ? createVNode("span", {
      "style": {
        overflow: "hidden",
        textOverflow: "ellipsis",
        whiteSpace: "nowrap"
      }
    }, [value]) : slots.default && createVNode("span", {
      "style": {
        overflow: "hidden",
        textOverflow: "ellipsis",
        whiteSpace: "nowrap"
