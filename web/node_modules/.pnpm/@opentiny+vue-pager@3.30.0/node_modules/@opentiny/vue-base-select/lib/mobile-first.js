...
import { iconClose, iconCopy, iconHalfselect, iconCheck, iconCheckedSur, iconLoading, iconChevronRight, iconDownWard, iconSearch, iconEllipsis, iconChevronUp, iconAddCircle, iconLoadingShadow } from '@opentiny/vue-icon';
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createElementBlock(
    ...
    mergeProps({
      ...
      class: ["inline-block relative w-full outline-0 group/base-select [&_[data-tag=tiny-tag]]:max-w-[144px]", [_ctx.hoverExpand ? "align-top is-hover-expand" : "", _ctx.clickExpand ? "is-click-expand" : "", (_ctx.state.inputHovering || _ctx.state.visible) && !_ctx.clickExpand ? "is-hover" : "", _ctx.state.showCollapseTag ? "collapse-tag-clicked" : "", _ctx.$parent.$attrs.class]],
      ...
      [_ctx.shape === "filter" ? (openBlock(), createBlock(_component_tiny_filter_box, {
        ...
        suffix: withCtx(function() {
          return [renderSlot(_ctx.$slots, "suffix"), _ctx.state.showCopy ? (openBlock(), createElementBlock("span", {
            ...
            class: normalizeClass([_ctx.gcls("caret"), "align-top group-hover/base-select:fill-color-brand"])
