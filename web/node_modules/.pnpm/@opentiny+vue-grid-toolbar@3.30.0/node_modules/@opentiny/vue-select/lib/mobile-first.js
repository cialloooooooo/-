...
var _hoisted_6 = ["disabled", "autocomplete", "aria-owns", "aria-controls"];
var _hoisted_7 = {
  key: 1
};
var _hoisted_8 = {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createElementBlock(
    ...
    mergeProps({
      ...
      class: ["inline-block relative w-full outline-0 group/select [&_[data-tag=tiny-tag]]:max-w-[144px]", [_ctx.hoverExpand ? "align-top" : "", _ctx.$parent.$attrs.class]],
    ...
    [createElementVNode("div", {
      ...
      title: _ctx.multiple && !_ctx.state.selectDisabled && _ctx.state.selected.length ? _ctx.state.selected.map(function(item) {
        return item.state ? item.state.currentLabel : item.currentLabel;
      }).join("; ") : !_ctx.multiple && _ctx.state.selectDisabled ? _ctx.state.selectedLabel : ""
      ...
      [!_ctx.state.selectDisabled ? (openBlock(), createElementBlock(
        ...
        [(_ctx.collapseTags || _ctx.state.device === "mb") && _ctx.state.selectedVal.length ? (openBlock(), createElementBlock(
          ...
          [(openBlock(), createBlock(_component_tiny_tag, {
            ...
            default: withCtx(function() {
              return [createVNode(_component_tiny_tooltip, {
                ...
                key: "0"
              } : void 0]), 1032, ["effect", "placement", "popper-class"])];
            }),
            _: 3
            /* FORWARDED */
          }, 8, ["closable", "size", "hit", "class", "maxWidth"])), _ctx.state.selectedVal.length > 1 ? (openBlock(), createBlock(_component_tiny_tag, {
            key: 0,
            closable: false,
            size: _ctx.state.collapseTagSize,
            ...
            _: 1
            /* STABLE */
          }, 8, ["size", "class", "maxWidth"])) : createCommentVNode("v-if", true)],
          2
          /* CLASS */
          ...
          [_ctx.hoverExpand ? (openBlock(), createBlock(_component_tiny_tag, {
            ...
            _: 1
            /* STABLE */
          }, 8, ["class", "size", "maxWidth"])) : createCommentVNode("v-if", true), (openBlock(true), createElementBlock(
            Fragment,
            null,
            renderList(_ctx.state.selected, function(item, index) {
              return openBlock(), createBlock(_component_tiny_tag, {
                ...
                _: 2
                /* DYNAMIC */
              }, 1032, ["closable", "size", "hit", "class", "onClose", "maxWidth"]);
            }),
            128
            /* KEYED_FRAGMENT */
          ))],
        ...
        [createVNode(_component_tiny_tooltip, {
          ...
          content: withCtx(function() {
            return [createElementVNode(
              ...
              [_ctx.slots.label ? (openBlock(), createElementBlock("span", _hoisted_4, [(openBlock(true), createElementBlock(
                Fragment,
                null,
          ...
          default: withCtx(function() {
            return [createElementVNode("span", _hoisted_3, [(openBlock(true), createElementBlock(
              Fragment,
              null,
              renderList(_ctx.state.selected, function(item) {
                return openBlock(), createElementBlock("span", {
          ...
          _: 3
          /* FORWARDED */
        }, 8, ["effect", "placement", "disabled", "popper-class"])],
        2
        /* CLASS */
      ...
      }, null, 46, _hoisted_6)), [[vModelText, _ctx.state.query]]) : createCommentVNode("v-if", true)],
      6
      /* CLASS, STYLE */
      ...
      suffix: withCtx(function() {
        return [renderSlot(_ctx.$slots, "suffix"), _ctx.state.showCopy ? (openBlock(), createElementBlock("span", {
          ...
          class: normalizeClass([_ctx.gcls("caret"), "align-top group-hover/select:fill-color-brand"])
      ...
      key: "0"
    } : void 0]), 1032, ["modelValue", "placeholder", "name", "id", "autocomplete", "size", "disabled", "readonly", "display-only", "display-only-content", "unselectable", "tabindex", "show-empty-value", "onFocus", "onBlur", "onKeyup", "onKeydown", "onPaste", "onMouseenter", "onMouseleave", "onCompositionend", "aria-owns", "aria-controls"])) : createCommentVNode("v-if", true), createVNode(Transition, {
        ...
        return [withDirectives(createVNode(_component_tiny_select_dropdown, {
          ...
          default: withCtx(function() {
            return [_ctx.shape && _ctx.filterable ? (openBlock(), createElementBlock(
              ...
              [_ctx.loadingText || _ctx.slots.empty ? (openBlock(), createElementBlock("div", _hoisted_8, [_ctx.slots.empty ? renderSlot(_ctx.$slots, "empty", {
                key: 0
              }) : (openBlock(), createElementBlock(
                "p",
                _hoisted_9,
                ...
                1
                /* TEXT */
              ))])) : (openBlock(), createElementBlock("div", _hoisted_10, [!_ctx.loading ? (openBlock(), createElementBlock(
                "span",
                _hoisted_11,
                toDisplayString(_ctx.state.emptyText),
                1
          ...
          _: 3
          /* FORWARDED */
        }, 8, ["title", "close-by-mask", "search-placeholder", "is-drop-inherit-width", "placement", "append-to-body", "style", "popper-options", "class", "height", "id"]), [[vShow, !_ctx.onCopying() && !_ctx.hideDrop && _ctx.state.visible && _ctx.state.emptyText !== false]])];
      }),
      _: 3
      /* FORWARDED */
    }, 8, ["onBeforeEnter", "onAfterLeave"])], 14, _hoisted_1), _ctx.hoverExpand && !_ctx.state.isDisplayOnly ? (openBlock(), createElementBlock(
      "div",
      {
        key: 0,
