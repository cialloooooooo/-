...
import { openBlock, createElementBlock, toDisplayString, renderSlot, normalizeClass, normalizeStyle, createCommentVNode, Fragment, createTextVNode } from 'vue';
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [_ctx.data ? (openBlock(), createElementBlock(
    ...
    [renderSlot(_ctx.$slots, "content", {}, function() {
      ...
      }, toDisplayString(_ctx.state.content), 9, _hoisted_3)) : createCommentVNode("v-if", true), !_ctx.state.href ? (openBlock(), createElementBlock("span", _hoisted_4, [!_ctx.isDot ? (openBlock(), createElementBlock(
        Fragment,
        {
          key: 0
        },
