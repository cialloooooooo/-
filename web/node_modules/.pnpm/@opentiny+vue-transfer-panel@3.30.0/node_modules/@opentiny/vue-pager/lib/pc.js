...
var _sfc_main = /* @__PURE__ */ defineComponent({
  name: $prefix + "Pager",
  props: [].concat(props, ["accurateJumper", "appendToBody", "currentPage", "disabled", "hideOnSinglePage", "isBeforePageChange", "layout", "mode", "nextText", "pageCount", "pageSize", "pageSizes", "pagerCount", "popperAppendToBody", "showTotalLoading", "customTotal", "popperClass", "prevText", "total", "size", "align", "totalFixedLeft", "pageSizeText", "changeCompat"]),
  directives: {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  var _component_chevron_down = resolveComponent("chevron-down");
          ...
          [item === "prev" ? (openBlock(), createElementBlock("button", {
            ...
            reference: withCtx(function() {
              ...
              return [createElementVNode("div", {
                ...
                [createElementVNode(
                  ...
                  1
                  /* TEXT */
                ), createElementVNode("div", _hoisted_12, [createVNode(_component_chevron_down, {
            ...
            default: withCtx(function() {
              return [createElementVNode("div", _hoisted_13, [createElementVNode("ul", _hoisted_14, [(openBlock(true), createElementBlock(
                Fragment,
                null,
                renderList(_ctx.state.internalPageSizes, function(sizeItem, sizeIndex) {
