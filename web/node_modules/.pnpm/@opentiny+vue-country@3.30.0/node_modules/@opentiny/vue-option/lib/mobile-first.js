...
var _hoisted_1 = ["data-index", "aria-label", "aria-selected"];
var _hoisted_2 = {
  key: 0,
  class: "w-4 mr-2"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createElementBlock("div", {
    ...
    class: normalizeClass(_ctx.m("h-fit flex items-center justify-between rounded text-color-text-primary text-sm sm:text-xs", "min-h-[40px] sm:min-h-[32px] cursor-pointer group/option sm:hover:bg-color-bg-4 sm:active:bg-color-bg-3 pl-0 pr-3 sm:px-2 my-1 sm:m-1", {
    ...
    role: "option",
    "aria-label": _ctx.state.currentLabel,
    "aria-selected": _ctx.state.itemSelected
    ...
    class: normalizeClass(_ctx.m("fill-color-icon-secondary relative w-3.5 h-3.5", {
      "group-hover/option:fill-color-brand-hover": _ctx.state.hover,
      "fill-color-brand text-color-brand": _ctx.state.itemSelected,
    ...
    "custom-class": "w-3.5 h-3.5 fill-color-brand"
