...
import { defineComponent, $prefix, $props, setup, h, props } from '@opentiny/vue-common';
...
var tabNavPcProps = _extends({}, $props, {
  panes: {
    type: Array,
...
_extends({}, $props);
var tabBarProps = _extends({}, $props, {
  tabs: Array
});
...
var _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  render: function render() {
    ...
    }, [createVNode(resolveComponent("IconChevronLeft"), {
      "aria-hidden": "true"
    }, null)]), !showMoreTabs ? createVNode("span", {
    ...
    }, [createVNode(resolveComponent("IconChevronRight"), {
      "aria-hidden": "true"
    }, null)]) : null];
    ...
    var paddingRight = this.$refs.more ? this.$refs.more.offsetWidth + "px" : "0";
...
var _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: [].concat(props, ["tabStyle", "activeName", "withClose", "withAdd", "size", "modelValue", "editable", "position", "beforeLeave", "stretch", "showMoreTabs", "popperClass", "popperAppendToBody", "dropConfig", "tooltipConfig", "separator", "beforeClose", "overflowTitle", "titleWidth", "moreShowAll", "panelMaxHeight", "panelWidth", "headerOnly"]),
  components: {
    TabNav: _sfc_main$1,
    IconPlus: iconPlus()
  },
  ...
  render: function render2() {
    ...
    }, [createVNode(resolveComponent("icon-plus"), {
      "aria-hidden": "true"
    }, null)]) : null;
    var navData = {
      props: {
    ...
    var panels = headerOnly ? (_this$slots$default = (_this$slots = this.slots).default) == null ? void 0 : _this$slots$default.call(_this$slots) : createVNode("div", {
      "class": "tiny-tabs__content"
    }, [(_this$slots$default2 = (_this$slots2 = this.slots).default) == null ? void 0 : _this$slots$default2.call(_this$slots2)]);
    return createVNode("div", {
      "class": (_class2 = {
        "tiny-tabs": true,
        "tiny-tabs--card": tabStyle === "card"
      }, _class2["tiny-tabs--" + (!state.separator ? position : "top")] = true, _class2["tiny-tabs--border-card"] = tabStyle === "border-card", _class2["tiny-tabs--button-card"] = tabStyle === "button-card", _class2["tiny-tabs--small"] = size === "small", _class2["tiny-tabs--large"] = size === "large", _class2["tiny-tabs--header-only"] = headerOnly, _class2)
