...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [createElementVNode("table", {
    ...
    128
    /* KEYED_FRAGMENT */
  )), _ctx.data && _ctx.data.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_9, [createElementVNode("td", {
    colspan: _ctx.columns.length
  }, toDisplayString(_ctx.t("ui.transfer.noData")), 9, _hoisted_10)])) : createCommentVNode("v-if", true)])], 8, _hoisted_2)]);
}
