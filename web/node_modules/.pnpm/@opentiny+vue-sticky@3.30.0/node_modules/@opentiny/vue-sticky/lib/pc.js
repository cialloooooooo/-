...
import '@opentiny/vue-theme/sticky/index.css';
...
var _sfc_main = defineComponent({
  emits: ["change", "scroll"],
  props: [].concat(props, ["zIndex", "target", "offset", "position"]),
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    ...
    [createElementVNode(
      "div",
      {
        class: normalizeClass(_ctx.state.isFixed && "tiny-sticky--fixed"),
        style: normalizeStyle(_ctx.state.stickyStyle)
      },
