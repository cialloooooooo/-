...
var _hoisted_1 = ["aria-checked", "aria-disabled", "aria-label", "tabindex"];
var _hoisted_2 = {
  key: 0,
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("span", {
    class: normalizeClass(_ctx.m(_ctx.gcls("switch-default"), _ctx.gcls("switch-" + (_ctx.size ? _ctx.size : "small")), _ctx.gcls((_ctx.state.currentValue === _ctx.trueValue ? "switch-true" : "switch-false") + (_ctx.state.disabled || _ctx.types === "loading" ? "-disabled" : "-not-disabled")))),
    "data-tag": "tiny-switch",
    role: "switch",
    "aria-checked": _ctx.state.currentValue === _ctx.trueValue,
    "aria-disabled": _ctx.state.disabled || _ctx.types === "loading",
    "aria-label": _ctx.types === "word" ? void 0 : _ctx.state.currentValue === _ctx.trueValue ? "on" : "off",
    ...
    "span",
    {
      ...
      class: normalizeClass(_ctx.m(_ctx.gcls("switch-handle-default"), _ctx.gcls("switch-handle-" + (_ctx.size ? _ctx.size : "small")), _ctx.gcls(_ctx.state.currentValue === _ctx.trueValue ? "switch-handle-true-" + (_ctx.size ? _ctx.size : "small") + (_ctx.state.disabled || _ctx.types === "loading" ? "-disabled" : "") : "switch-handle-false-" + (_ctx.size ? _ctx.size : "small") + (_ctx.state.disabled || _ctx.types === "loading" ? "-disabled" : ""))))
    },
    null,
    2
    /* CLASS */
    ...
    [_ctx.types === "word" ? (openBlock(), createElementBlock("div", _hoisted_2, [_ctx.state.currentValue === _ctx.trueValue ? renderSlot(_ctx.$slots, "open", {
      ...
      return [(openBlock(), createElementBlock(
        ...
        {
          viewBox: "0 0 24 24",
          class: normalizeClass([_ctx.gcls("switch-icon-" + (_ctx.size ? _ctx.size : "small")), _ctx.gcls("switch-icon-true-" + (_ctx.state.disabled ? "disabled" : "default"))])
        },
        _hoisted_5,
        2
        /* CLASS */
      ...
      return [(openBlock(), createElementBlock(
        ...
        {
          viewBox: "0 0 24 24",
          class: normalizeClass([_ctx.gcls("switch-icon-" + (_ctx.size ? _ctx.size : "small")), _ctx.gcls("switch-icon-false-" + (_ctx.state.disabled ? "disabled" : "default"))])
        },
        _hoisted_7,
        2
        /* CLASS */
