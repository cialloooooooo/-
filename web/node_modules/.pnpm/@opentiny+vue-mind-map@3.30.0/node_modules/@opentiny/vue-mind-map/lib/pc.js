...
function _regenerator() {
  ...
  function i(r2, n2, o2, i2) {
    ...
    return _regeneratorDefine2(u2, "_invoke", (function(r3, n3, o3) {
      var i3, c3, u3, f2 = 0, p = o3 || [], y = false, G3 = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d2(t2, r4) {
        return i3 = t2, c3 = 0, u3 = e, G3.n = r4, a;
      } };
      function d(r4, n4) {
        for (c3 = r4, u3 = n4, t = 0; !y && f2 && !o4 && t < p.length; t++) {
          var o4, i4 = p[t], d2 = G3.p, l = i4[2];
          r4 > 3 ? (o4 = l === n4) && (u3 = i4[(c3 = i4[4]) ? 5 : (c3 = 3, 3)], i4[4] = i4[5] = e) : i4[0] <= d2 && ((o4 = r4 < 2 && d2 < i4[1]) ? (c3 = 0, G3.v = n4, G3.n = i4[1]) : d2 < l && (o4 = r4 < 3 || i4[0] > n4 || n4 > l) && (i4[4] = r4, i4[5] = n4, G3.n = l, c3 = 0));
        }
        if (o4 || r4 > 1) return a;
        throw y = true, n4;
      }
      return function(o4, p2, l) {
        ...
        for (y && 1 === p2 && d(p2, l), c3 = p2, u3 = l; (t = c3 < 2 ? e : u3) || !y; ) {
          i3 || (c3 ? c3 < 3 ? (c3 > 1 && (G3.n = -1), d(c3, u3)) : G3.n = u3 : G3.v = u3);
          try {
            if (f2 = 2, i3) {
              ...
              i3 = e;
            } else if ((t = (y = G3.n < 0) ? u3 : r3.call(n3, G3)) !== a) break;
          } catch (t2) {
            i3 = e, c3 = 1, u3 = t2;
          } finally {
            f2 = 1;
...
var Ye = function Ye2() {
  ...
  if (e.parent = t, e.children) for (var n = 0; n < e.children.length; n++) _$(e.children[n], e);
};
function Te(e) {
  if (e.id = J(), e.children) for (var t = 0; t < e.children.length; t++) Te(e.children[t]);
}
...
function De(e) {
  return JSON.parse(JSON.stringify(e, function(n, o) {
    if (n !== "parent") return o;
  }));
}
var K = function K2(e, t) {
  var n = 0, o = 0;
  for (; t && t !== e; ) n += t.offsetLeft, o += t.offsetTop, t = t.offsetParent;
  return {
    offsetLeft: n,
    offsetTop: o
  };
...
function Qe(e) {
  e.map.addEventListener("click", function(t) {
    ...
    var n = t.target;
    if (n.tagName === "ME-EPD") e.expandNode(n.previousSibling);
    else if (e.editable) ae(n) ? e.selectNode(n, false, t) : n.tagName === "text" ? n.dataset.type === "custom-link" ? e.selectLink(n.parentElement) : e.selectSummary(n.parentElement) : n.className === "circle" || e.hideLinkController && e.hideLinkController();
    else return;
  }), e.map.addEventListener("dblclick", function(t) {
    if (t.preventDefault(), !e.editable) return;
    var n = t.target;
...
var Ze = {
    ...
    return {
      ...
      fire: function fire(e) {
        if (this.handlers[e] instanceof Array) {
          ...
          for (var o = 0; o < n.length; o++) n[o].apply(n, t);
        }
      },
      removeListener: function removeListener(e, t) {
        ...
        var n = this.handlers[e];
        if (!t) n.length = 0;
        else if (n.length) for (var o = 0; o < n.length; o++) n[o] === t && this.handlers[e].splice(o, 1);
      }
    };
  }
  ...
  } else e.linkContainer && (e.linkContainer = void 0);
...
var lt = function lt2(e) {
  var _this = this;
  if (console.time("editTopic"), !e) return;
  ...
  if (console.time("editSummary"), !t) return;
...
var ht = function ht2(e) {
  ...
  for (var o = 0; o < n.length; o++) {
    ...
    var f = "";
    if (this.mainLinkStyle === 2) this.direction === X && (l === "lhs" ? c = c - t.offsetWidth / 6 : c = c + t.offsetWidth / 6), f = ut({
      x1: c,
      y1: h,
      x2: a,
      y2: m
  ...
  for (var h = 0; h < e.length; h++) {
    ...
    var f = u.children[1];
    if (f) {
      if (f.style.bottom = -(f.offsetHeight / 2) + "px", n === "lhs" ? f.style.left = "10px" : n === "rhs" && (f.style.right = "10px"), !f.expanded) continue;
    } else continue;
...
function mt(e, t) {
  ...
  e.container.oncontextmenu = function(b2) {
    if (b2.preventDefault(), !e.editable) return;
    var x = b2.target;
    if (ae(x)) {
...
function bt(e) {
  var t = {
    ...
    38: function _(n) {
      if (n.altKey) e.moveUpNode();
      else {
        if (n.metaKey || n.ctrlKey) return e.initSide();
        e.selectPrevSibling();
      }
    },
    40: function _(n) {
    ...
    37: function _(n) {
      var s;
      if (n.metaKey || n.ctrlKey) return e.initLeft();
    ...
    39: function _(n) {
      var s;
      if (n.metaKey || n.ctrlKey) return e.initRight();
      if (!e.currentNode) return;
      var o = e.currentNode.nodeObj, i = e.currentNode.offsetParent.offsetParent.parentElement;
  ...
  e.map.onkeydown = function(n) {
    if (n.preventDefault(), !!e.editable && n.target === n.currentTarget) if (n.keyCode === 8 || n.keyCode === 46) e.currentLink ? e.removeLink() : e.currentSummary ? e.removeSummary(e.currentSummary.summaryObj.id) : e.currentNode ? e.removeNode() : e.currentNodes && e.removeNodes(e.currentNodes);
    else {
      var o = t[n.keyCode];
      o && o(n);
    }
...
function Et(e) {
  ...
  e.map.addEventListener("dragstart", function(r) {
    ...
    var _ref5 = _asyncToGenerator(/* @__PURE__ */ _regenerator().m(function _callee(r) {
      var l, c, _t2;
      return _regenerator().w(function(_context) {
        while (1) switch (_context.n) {
          ...
          case 2:
            ...
            c = t.nodeObj;
            _t2 = n;
            _context.n = _t2 === "before" ? 3 : _t2 === "after" ? 4 : _t2 === "in" ? 5 : 6;
            break;
          case 3:
...
function j(_ref6, t, n) {
  var e = _ref6.style;
  if (typeof t == "object") for (var _i = 0, _Object$entries = Object.entries(t); _i < _Object$entries.length; _i++) {
...
var ze = /* @__PURE__ */ (function(_Tt) {
  ...
  _proto2._onTapStart = function _onTapStart(t, n) {
    ...
    if (!this._targetElement || !h.find(function(p) {
      ...
      return u.includes(p);
    }) || !n && this._emitEvent("beforestart", t) === false) return;
    this._areaLocation = {
      x1: o,
      y1: i,
      x2: 0,
  ...
  _proto2._onSingleTap = function _onSingleTap(t) {
    ...
    } else r.includes(s) && (r.length === 1 || t.ctrlKey || r.every(function(l2) {
  ...
  _proto2._onScroll = function _onScroll() {
    ...
    var t = this._scrollDelta, n = this._options.document, _ref0 = (_n$scrollingElement = n.scrollingElement) != null ? _n$scrollingElement : n.body, o = _ref0.scrollTop, i = _ref0.scrollLeft;
  ...
  _proto2._updateElementSelection = function _updateElementSelection() {
    ...
    for (var m = 0; m < t.length; m++) {
      ...
      if (xe(i, f.getBoundingClientRect(), c)) {
        if (r.includes(f)) s.includes(f) && !l.includes(f) && l.push(f);
...
function Ot(e) {
  ...
  }).on("beforestart", function(_ref1) {
    var n = _ref1.event;
    if (n.button !== e.mouseSelectionButton || n.target.tagName === "ME-TPC" || n.target.id === "input-box" || n.target.className === "circle") return false;
  ...
  }).on("start", function(_ref10) {
    var n = _ref10.event;
    !n.ctrlKey && !n.metaKey && (e.unselectNode(), e.unselectNodes(), e.unselectSummary(), e.unselectLink(), t.clearSelection(true, true));
  }).on("move", function(_ref11) {
    var _ref11$store$changed = _ref11.store.changed, n = _ref11$store$changed.added, o = _ref11$store$changed.removed;
    S.moved = true;
  ...
  }).on("stop", function(_ref12) {
    var n = _ref12.store.stored;
    e.selectNodes(n);
  });
  e.selection = t;
}
...
var Pt = function Pt2(e, t, n) {
  ...
  var t;
  if (e) t = e.firstChild.firstChild;
  else return false;
  ...
  return JSON.stringify(e, function(t, n) {
    if (!(t === "parent" && typeof n != "string")) return n;
  });
}, It = function It2() {
...
var qe = function qe2(e, t) {
  ...
  if (i.tagName === "ME-PARENT") {
    if (i.children[1]) i.nextSibling.appendChild(s);
    else {
      var h = this.createChildren([s]);
      i.appendChild(re(true)), i.insertAdjacentElement("afterend", h);
    }
    this.linkDiv(s.offsetParent);
  } else i.tagName === "ME-ROOT" && (qe(this.direction, o) === L ? (l = document.querySelector(".lhs")) == null || l.appendChild(s) : (c = document.querySelector(".rhs")) == null || c.appendChild(s), this.linkDiv());
  return {
    newTop: r,
    newNodeObj: o
  };
  ...
  if (!t) return;
  var n = t.nodeObj;
  if (n.root === true) throw new Error("Can not remove root node");
  ...
  } else this.selectNode(N(n.parent.id));
  ...
  for (var _iterator0 = _createForOfIteratorHelperLoose(e), _step0; !(_step0 = _iterator0()).done; ) {
    var t = _step0.value;
    var n = t.nodeObj;
    if (n.root === true) continue;
    var o = Q(n);
    Ve(t, o);
  }
  this.linkDiv(), this.bus.fire("operation", {
  ...
  if (r.tagName === "ME-PARENT") {
    if (le(e), r.children[1]) r.nextSibling.appendChild(s.parentElement);
    else {
      var c = this.createChildren([s.parentElement]);
      r.appendChild(re(true)), r.parentElement.insertBefore(c, r.nextSibling);
    }
  } else r.tagName === "ME-ROOT" && (qe(this.direction, n), r.nextSibling.appendChild(s.parentElement));
  this.linkDiv(), this.bus.fire("operation", {
    name: "moveNode",
    obj: n,
    toObj: o,
...
var Dn = function Dn2(e, t, n, o) {
  ...
  var t;
  if (e ? t = e : t = this.currentLink, !t) return;
...
function qn(e) {
  var _this7 = this;
  if (console.time("editSummary"), !e) return;
  var t = e.children[2];
...
var Vn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  if (e.length === 1) {
    ...
    if (!u) throw new Error("Can not select root node.");
  ...
  e: for (; o < t; o++) {
    ...
    for (var _u = 1; _u < n.length; _u++) if (((h = n[_u][o]) == null ? void 0 : h.node) !== _a2) break e;
  }
  if (!o) throw new Error("Can not select root node.");
  var i = n.map(function(a2) {
    return a2[o - 1].index;
  }).sort(), s = i[0] || 0, r = i[i.length - 1] || 0, l = n[0][o - 1].node;
  if (l.root) throw new Error("Please select nodes in the same main topic.");
  return {
    parent: l.id,
    start: s,
    end: r
...
}, Un = function Un2(_ref13) {
  var e = _ref13.parent, t = _ref13.start;
  var s, r;
  ...
  for (var P = s; P <= r; P++) {
    ...
    if (!U) return console.warn("Child not found"), e.removeSummary(n), null;
  ...
  var _ref14 = _asyncToGenerator(/* @__PURE__ */ _regenerator().m(function _callee2(e) {
    ...
    return _regenerator().w(function(_context2) {
      while (1) switch (_context2.n) {
        ...
        case 1:
          o = _context2.v;
          return _context2.a(2, new Promise(function(i, s) {
            var r = new Image();
...
function uo(e, t) {
  return /* @__PURE__ */ _asyncToGenerator(/* @__PURE__ */ _regenerator().m(function _callee3() {
    var o, _len4, n, _key4, _args2 = arguments, _t3, _t4;
...
function D(_ref16) {
  var e = _ref16.el, t = _ref16.direction, n = _ref16.locale, o = _ref16.draggable, i = _ref16.editable, s = _ref16.contextMenu, r = _ref16.contextMenuOption, l = _ref16.toolBar, c = _ref16.keypress, h = _ref16.mouseSelectionButton, a = _ref16.before, u = _ref16.newTopicName, d = _ref16.allowUndo, p = _ref16.mainLinkStyle, g = _ref16.subLinkStyle, m = _ref16.overflowHidden, f = _ref16.mobileMenu, v = _ref16.theme;
  console.log("ME_version " + D.version, this);
  var y = null;
  var b = Object.prototype.toString.call(e);
  if (b === "[object HTMLDivElement]" ? y = e : b === "[object String]" && (y = document.querySelector(e)), !y) throw new Error("MindElixir: el is not a valid element");
