    ...
    [_ctx.uiMode === "default" ? (openBlock(), createElementBlock(
      ...
      reference: withCtx(function() {
        return [_ctx.shape === "filter" ? (openBlock(), createBlock(_component_tiny_filter_box, {
          ...
          blank: _ctx.blank,
          size: _ctx.size
        }, null, 8, ["label", "value", "tip", "disabled", "onClick", "show-close", "blank", "size"])) : (openBlock(), createBlock(_component_tiny_input, {
          key: 1,
          ...
          fn: withCtx(function() {
            return [createElementVNode(
              "div",
              {
                ...
                class: normalizeClass("pl-1 text-color-text-primary break-normal " + (_ctx.disabled ? "text-color-text-disabled" : "") + " " + (_ctx.size === "medium" ? "h-8 leading-8 text-sm w-9" : _ctx.size === "mini" ? "h-6 leading-6 text-xs w-7" : "h-7 leading-7 text-sm w-9 sm:text-xs sm:w-7"))
              },
