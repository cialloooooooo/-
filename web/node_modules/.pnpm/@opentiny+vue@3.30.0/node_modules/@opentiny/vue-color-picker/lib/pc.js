...
var _sfc_main = defineComponent({
  ...
  props: [].concat(props, ["modelValue", "visible", "alpha", "predefine", "history", "size", "format", "enableHistory", "enablePredefineColor", "colorMode"]),
  components: {
    ...
    [createElementVNode(
      ...
      default: withCtx(function() {
        return [createVNode(_component_color_select, {
          ...
          "color-mode": _ctx.$props.colorMode,
          "enable-history": _ctx.state.enableHistory,
          "enable-predefine-color": _ctx.state.enablePredefineColor
        }, null, 8, ["onConfirm", "onCancel", "modelValue", "visible", "alpha", "predefine", "history", "format", "color-mode", "enable-history", "enable-predefine-color"])];
      }),
      _: 1
      /* STABLE */
    })],
