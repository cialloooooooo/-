      ...
      return [withDirectives(createElementVNode(
        "div",
        {
          ...
          class: normalizeClass([[_ctx.state.popperClass, {
            "not-match-height": !_ctx.state.items.length
          }], "tiny-picker-panel tiny-time-select tiny-popper"])
        },
        [createVNode(_component_tiny_scrollbar, {
          ...
          default: withCtx(function() {
            return [_ctx.state.items.length ? (openBlock(), createElementBlock("div", _hoisted_1, [(openBlock(true), createElementBlock(
              Fragment,
              null,
              renderList(_ctx.state.items, function(item) {
                ...
                }, toDisplayString(item.value), 11, _hoisted_2);
              }),
              128
              /* KEYED_FRAGMENT */
              ...
              "div",
              _hoisted_3,
              toDisplayString(_ctx.$t("ui.select.noMatch")),
              1
              /* TEXT */
            ))];
          }),
