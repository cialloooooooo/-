...
var _sfc_main$3 = defineComponent({
  ...
  props: [].concat(props, ["vertical", "nameField", "statusField", "descriptionField", "data", "active", "visibleNum", "duration", "noArrow", "flex", "size", "contentCenter"]),
          ...
          return [createElementVNode(
            ...
            "div",
            {
              class: normalizeClass(["tiny-steps-text", node[_ctx.statusField] === "error" ? "fault" : node[_ctx.statusField], {
                "active": index === _ctx.active,
                "content-center": _ctx.contentCenter
              }])
            },
            [createElementVNode(
              "div",
