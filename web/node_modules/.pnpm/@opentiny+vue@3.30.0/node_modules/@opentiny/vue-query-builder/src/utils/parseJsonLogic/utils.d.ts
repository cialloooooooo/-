import { JsonLogicAnd, JsonLogicDoubleNegation, JsonLogicEqual, JsonLogicGreaterThan, JsonLogicGreaterThanOrEqual, JsonLogicLessThan, JsonLogicLessThanOrEqual, JsonLogicNegation, JsonLogicNotEqual, JsonLogicOr, JsonLogicStrictEqual, JsonLogicStrictNotEqual, JsonLogicVar, RQBJsonLogic, RQBJsonLogicEndsWith, RQBJsonLogicStartsWith, RQBJsonLogicVar } from '../../ts';
import { JsonLogicBetweenExclusive, JsonLogicBetweenInclusive } from './types';
...
export declare const isJsonLogicInArray: (logic: RQBJsonLogic) => logic is {
    in: [import('../../ts').JsonLogicRulesLogic<RQBJsonLogicStartsWith | RQBJsonLogicEndsWith>, import('../../ts').JsonLogicRulesLogic<RQBJsonLogicStartsWith | RQBJsonLogicEndsWith>[]];
};
