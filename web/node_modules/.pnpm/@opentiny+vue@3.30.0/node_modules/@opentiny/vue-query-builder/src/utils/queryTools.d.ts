import { OptionList, RuleGroupTypeAny, RuleType, UpdateableProperties, ValueSources } from '../ts';
 ...
 */
export declare const add: <RG extends RuleGroupTypeAny>(query: RG, ruleOrGroup: RuleType | RG, parentPath: number[], { combinators, combinatorPreceding, idGenerator }?: AddOptions) => any;
 ...
 */
export declare const update: <RG extends RuleGroupTypeAny>(query: RG, prop: UpdateableProperties, value: any, path: number[], { resetOnFieldChange, resetOnOperatorChange, getRuleDefaultOperator, getValueSources, getRuleDefaultValue }?: UpdateOptions) => any;
/**
 ...
 * @returns The updated query
 */
export declare const remove: <RG extends RuleGroupTypeAny>(query: RG, path: number[]) => any;
 ...
 * @returns The updated query
 */
export declare const move: <RG extends RuleGroupTypeAny>(query: RG, oldPath: number[], newPath: number[], { clone, combinators, idGenerator }?: MoveOptions) => any;
