...
import { addClass, getStyle, PopupManager, removeClass, afterLeave } from "@opentiny/utils";
import { defineComponent, $props, $setup, $prefix, createComponent, appProperties, hooks, directive as directive$1, setupComponent } from "@opentiny/vue-common";
...
var addStyle = function addStyle2(options, parent, instance) {
  ...
  if (options.fullscreen) {
    ...
    var clientRect = target == null ? void 0 : target.getBoundingClientRect();
    instance.originalPosition = getStyle(document.body, "position") || "";
    var direction = ["top", "left"];
    direction.forEach(function(property) {
      var scroll = property === "top" ? "scrollTop" : "scrollLeft";
      maskStyle[property] = ((clientRect == null ? void 0 : clientRect[property]) || 0) + document.body[scroll] + document.documentElement[scroll] + "px";
    });
    var size = ["height", "width"];
    size.forEach(function(property) {
      maskStyle[property] = ((clientRect == null ? void 0 : clientRect[property]) || 0) + "px";
    });
  } else {
...
var vLoading = {
  inserted: function inserted(el, binding, vnode) {
    ...
    var mask = createComponent({
      ...
      propsData: {
        _constants: constants,
        tiny_mode: (vm == null ? void 0 : (_vm$tiny_mode = vm.tiny_mode) == null ? void 0 : _vm$tiny_mode.value) || ((_appProperties$tiny_m2 = appProperties().tiny_mode) == null ? void 0 : _appProperties$tiny_m2.value)
      },
      el: document.createElement("div")
    });
