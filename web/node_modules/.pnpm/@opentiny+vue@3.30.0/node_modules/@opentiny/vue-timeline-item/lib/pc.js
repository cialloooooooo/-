...
import { resolveComponent, openBlock, createElementBlock, normalizeClass, normalizeStyle, Fragment, createElementVNode, toDisplayString, createBlock, resolveDynamicComponent, renderSlot, createCommentVNode, withDirectives, vShow, createTextVNode } from 'vue';
...
var _sfc_main = defineComponent({
  emits: ["click"],
  props: [].concat(props, ["node", "space", "lineWidth", "shape", "autoColorField", "nodeIndex", "description"]),
  components: {
    IconWarn: iconWarn(),
    IconClose: iconClose(),
    IconYes: iconYes()
  ...
  return openBlock(), createElementBlock(
    ...
    [!_ctx.rootProps.vertical ? (openBlock(), createElementBlock(
      ...
      [_ctx.rootProps.textPosition === "right" ? (openBlock(), createElementBlock(
        ...
        [createElementVNode(
          ...
          [renderSlot(_ctx.$slots, "description", {
            ...
            return [_ctx.description !== void 0 && _ctx.description !== null ? (openBlock(), createElementBlock(
              "span",
              _hoisted_5,
              toDisplayString(_ctx.description),
              1
              /* TEXT */
            )) : _ctx.node.description !== void 0 && _ctx.node.description !== null ? (openBlock(), createElementBlock(
              "span",
              _hoisted_6,
        ...
        [renderSlot(_ctx.$slots, "top", {
          ...
          return [createElementVNode("div", _hoisted_7, [createElementVNode(
            "span",
            _hoisted_8,
          ...
          2
          /* CLASS */
        )]), createElementVNode("div", _hoisted_11, [renderSlot(_ctx.$slots, "bottom", {
          slotScope: _ctx.node
        }, function() {
          return [createElementVNode("div", {
            class: "name",
          ...
          }, null, 8, _hoisted_12), _ctx.rootProps.showStatus ? (openBlock(), createElementBlock(
            "div",
            _hoisted_13,
      ...
      [renderSlot(_ctx.$slots, "left", {
        ...
        return [_ctx.shape === "circle" ? (openBlock(), createElementBlock("div", _hoisted_14, [createElementVNode(
          "span",
          _hoisted_15,
      ...
      }), createElementVNode("div", _hoisted_17, [_ctx.shape === "circle" ? (openBlock(), createElementBlock(
        "div",
        {
          key: 0,
          class: normalizeClass(_ctx.state.iconClass),
        ...
        key: 0,
        class: "fixicons"
      })) : (openBlock(), createElementBlock("span", _hoisted_19))])), _hoisted_20]), renderSlot(_ctx.$slots, "right", {
        slotScope: _ctx.node
      }, function() {
        return [createElementVNode("div", {
