...
import { resolveComponent, resolveDirective, openBlock, createElementBlock, mergeProps, withKeys, withModifiers, normalizeClass, createElementVNode, createVNode, withDirectives, vModelRadio, createCommentVNode, renderSlot, createTextVNode, toDisplayString } from 'vue';
...
var _hoisted_1 = ["aria-checked", "aria-disabled", "aria-labelledby", "aria-label"];
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("label", mergeProps({
    ...
    "aria-labelledby": _ctx.text || _ctx.label ? (_ctx.name || "radio") + "-" + _ctx.label + "-label" : null,
    "aria-label": _ctx.text || _ctx.label ? null : _ctx.text || _ctx.label,
    tabindex: "-1",
  ...
  }, _ctx.a(_ctx.$attrs, ["class", "style", "onClick"], true)), [!_ctx.state.isDisplayOnly ? (openBlock(), createElementBlock(
    "span",
    {
      key: 0,
    ...
    2
    /* CLASS */
  )) : createCommentVNode("v-if", true), withDirectives((openBlock(), createElementBlock("span", {
    "data-tag": "tiny-radio-label",
    ref: "label",
    id: (_ctx.name || "radio") + "-" + _ctx.label + "-label",
  ...
  })], 42, _hoisted_4)), [[_directive_auto_tip]])], 16, _hoisted_1);
}
