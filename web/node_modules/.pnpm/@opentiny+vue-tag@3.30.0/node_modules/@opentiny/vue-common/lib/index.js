...
import { capitalize, camelize, hyphenate, debounce, isServer } from "@opentiny/utils";
import { t } from "@opentiny/vue-locale";
import "@opentiny/vue-theme/base/index.css";
import { useInstanceSlots as useInstanceSlots$1, useRelation as useRelation$1 } from "@opentiny/vue-hooks";
...
var __TINY__ = typeof window === "undefined" ? null : window.__Longque__;
...
var renderComponent = function renderComponent2(_ref) {
  var _ref$view = _ref.view, view = _ref$view === void 0 ? void 0 : _ref$view, _ref$component = _ref.component, component = _ref$component === void 0 ? void 0 : _ref$component, props2 = _ref.props, customDesignProps = _ref.customDesignProps, _ref$context = _ref.context, attrs = _ref$context.attrs, slots = _ref$context.slots, _ref$extend = _ref.extend, extend = _ref$extend === void 0 ? {} : _ref$extend;
  return function() {
    return hooks.h(view && view.value || component, _extends({
      ref: "modeTemplate"
    }, props2, attrs, customDesignProps, extend), slots);
  };
};
...
var getCustomProps = function getCustomProps2() {
  var _instance$vnode;
  var instance = hooks.getCurrentInstance();
  return (instance == null ? void 0 : (_instance$vnode = instance.vnode) == null ? void 0 : _instance$vnode.props) || {};
};
...
var setInstanceEmitter = function setInstanceEmitter2(instance) {
  var $emitter = emitter();
  if (typeof instance.$emitter === "undefined") Object.defineProperty(instance, "$emitter", {
    get: function get() {
      return $emitter;
    }
  });
...
var originalDefineProperties = function originalDefineProperties2(vm, instance, property, filter22) {
...
var harmonyDefineProperties = function harmonyDefineProperties2(vm, instance, property) {
  var propertyFilterFlags = __TINY__.SKIP_PREFIX_UNDERSCORE;
  __TINY__.createDelegate(instance[property], vm, propertyFilterFlags);
};
var defineProperties = __TINY__ ? harmonyDefineProperties : originalDefineProperties;
...
var tools = function tools2(context, mode) {
  ...
  return {
    ...
    service: root != null && root.$getService ? root == null ? void 0 : root.$getService(vm) : root == null ? void 0 : root.$service,
...
var parseProps = function parseProps2(propsData) {
  ...
  for (var name in propsData) {
    if (name === "class" || name === "style") {
      ...
      for (var eventName in events) props2["on" + capitalize(camelize(eventName))] = events[eventName];
    } else if (name === "attrs" || name === "props" || name === "domProps") {
      var attrs = propsData[name];
      for (var key in attrs) props2[key] = attrs[key];
    } else {
      props2[name] = propsData[name];
    }
  }
...
var h = function h2(component, propsData, childData) {
  ...
  if (typeof childData === "string" || Array.isArray(childData)) children22 = typeof component !== "string" || customElement ? function() {
    return childData;
  } : childData;
...
var useBreakpoint = function useBreakpoint2() {
  ...
  var createMatchMedia = function createMatchMedia2(mediaQueryString) {
...
var props = ["tiny_mode", "tiny_mode_root", "tiny_template", "tiny_renderless", "_constants", "tiny_theme", "tiny_chart_theme", "tiny_mcp_config"];
...
var getDesignConfig = function getDesignConfig2() {
...
var getComponentMcpConfig = function getComponentMcpConfig2() {
  var _mcpConfig$components;
  var mcpConfig = globalMcpConfig.mcpConfig;
  var componentName = getComponentName().replace($prefix, "");
  return mcpConfig == null ? void 0 : (_mcpConfig$components = mcpConfig.components) == null ? void 0 : _mcpConfig$components[componentName];
};
var globalMcpConfig = {
  mcpConfig: null,
  createMcpTools: null
};
var registerMcpConfig = function registerMcpConfig2(mcpConfig, defineTool) {
  globalMcpConfig.mcpConfig = mcpConfig;
  globalMcpConfig.createMcpTools = defineTool;
};
var $setup = function $setup2(_ref4) {
  var propData = _ref4.props, context = _ref4.context, template = _ref4.template, _ref4$extend = _ref4.extend, extend = _ref4$extend === void 0 ? {} : _ref4$extend;
  var mode = resolveMode(propData, context);
  var view = hooks.computed(function() {
    if (typeof propData.tiny_template !== "undefined") return propData.tiny_template;
    var component = template(mode, propData);
    return typeof component === "function" ? defineAsyncComponent(component) : component;
  });
  var _getDesignConfig = getDesignConfig(), designConfig = _getDesignConfig.designConfig;
  var customDesignProps = {};
  var designProps = designConfig == null ? void 0 : designConfig.props;
  if (designProps) {
    var customProps = getCustomProps();
    Object.keys(designProps).forEach(function(key) {
      var camelKey = key.replace(/-(\w)/g, function(_, c) {
        return c.toUpperCase();
      });
      var kebabKey = key.replace(/([A-Z])/g, "-$1").toLowerCase();
      if (!Object.prototype.hasOwnProperty.call(customProps, camelKey) && !Object.prototype.hasOwnProperty.call(customProps, kebabKey)) {
...
var setup = function setup2(_ref5) {
  ...
  var _getDesignConfig2 = getDesignConfig(), designConfig = _getDesignConfig2.designConfig, globalDesignConfig = _getDesignConfig2.globalDesignConfig;
  var utils = _extends({
    $prefix,
    t
  ...
  var componentMcpConfig = getComponentMcpConfig();
  if (componentMcpConfig && props2.tiny_mcp_config && globalMcpConfig.createMcpTools) {
    globalMcpConfig.createMcpTools(attrs.vm, props2.tiny_mcp_config, componentMcpConfig);
  }
  return attrs;
};
function svg(_ref6) {
  var _ref6$name = _ref6.name, name = _ref6$name === void 0 ? "Icon" : _ref6$name, component = _ref6.component, _ref6$filledComponent = _ref6.filledComponent, filledComponent = _ref6$filledComponent === void 0 ? null : _ref6$filledComponent, _ref6$deprecatedBy = _ref6.deprecatedBy, deprecatedBy = _ref6$deprecatedBy === void 0 ? "" : _ref6$deprecatedBy;
  if (deprecatedBy) {
  ...
  return function(propData) {
    return markRaw(defineComponent({
      ...
      setup: function setup3(props2, context) {
        var _ref7 = context.attrs || {}, fill = _ref7.fill, width = _ref7.width, height = _ref7.height, customClass = _ref7["custom-class"];
        ...
        var extend = Object.assign({
          style: {
            ...
            width,
            height,
            "--tiny-first-color": props2.firstColor || "",
            "--tiny-second-color": props2.secondColor || "",
            "--tiny-underlay-bg": props2.underlay ? props2.underlay.background : "#eef3fe",
            "--tiny-underlay-br": props2.underlay ? props2.underlay.borderRadius : "4px",
            "--tiny-underlay-scale": props2.underlay ? props2.underlay.scale : 0.8
          },
          class: className,
          isSvg: true
        }, attrs);
        ...
        if (GRADIENT_ICONS_LIST.includes(name)) {
          ...
          component.render = function() {
            var newRender = component.__raw_render.bind(this);
            var vnode = newRender.apply(void 0, arguments);
            generateIcon(vnode);
            return vnode;
          };
        }
        var view = hooks.computed(function() {
          return props2.shape === "line" ? component : filledComponent;
        });
        return renderComponent({
          view,
          props: mergeProps,
