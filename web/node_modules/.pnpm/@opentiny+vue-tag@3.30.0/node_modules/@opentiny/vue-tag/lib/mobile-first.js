...
import { api, renderless } from "@opentiny/vue-renderless/tag/vue";
...
var _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  emits: ["click", "close"],
  props: [].concat(props, ["text", "closable", "operable", "selectable", "type", "theme", "hit", "disabled", "color", "size", "effect", "customClass", "value", "maxWidth"]),
  ...
  render: function render() {
    var slots = this.slots, selectable = this.selectable, disabled = this.disabled, color = this.color, handleClose = this.handleClose, handleClick = this.handleClick, customClass = this.customClass, hit = this.hit, m = this.m, gcls = this.gcls, state = this.state, value = this.value, maxWidth = this.maxWidth;
    ...
    var classes2 = m("text-xs inline-flex items-center rounded box-border border-0.5 sm:border mr-1 align-bottom", effect === "plain" || hit ? gcls(type + "-border") : "border-transparent", gcls(effect + "-" + type), gcls(size), {
      hidden: !state.show
